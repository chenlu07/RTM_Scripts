...
public class CrowdManager : MonoBehaviour {
	...
	protected GameObject SpawnRandom(){
		GameObject character = (GameObject)Instantiate(FullCharacter, RandomPoint(new Vector3(0, 0, 0), 50.0f), Quaternion.identity);
    ...
    protected GameObject generateWanderPoint_lowheat()
    {
        GameObject prefabwander1 = (GameObject)Instantiate(wander, new Vector3(36.4f, 0.0f, 44.6f), Quaternion.identity);
        return prefabwander1;
    }

    protected GameObject generateWanderPoint_middleheat()
    {
        // GameObject prefabwander2 = (GameObject)Instantiate(wander, new Vector3(26.2f, 0.0f,-26.7f), Quaternion.identity);
        GameObject prefabwander2 = (GameObject)Instantiate(wander, new Vector3(2f, 0.0f, 2f), Quaternion.identity);
        return prefabwander2;
    }

    protected GameObject generateWanderPoint_highheat()
    {
        GameObject prefabwander3 = (GameObject)Instantiate(wander, new Vector3(34.8f, 0.0f, -2.2f), Quaternion.identity);
        return prefabwander3;
    }
}